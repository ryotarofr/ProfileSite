...
function GithubCard({ data }: { data: any }) {
  return (
    <Tilt className="flex flex-col justify-center items-center" perspective={500}>

      <div className="select-none">
        <div
          className="w-[1000px] c-laptop:w-full mini-laptop:w-full 
        tablet:w-full mobile:w-full  rounded-3xl 
  bg-gradient-to-t to-[#023e91fd] from-[#010409]  mobile:rounded-xl
  pt-10 pb-4 px-6"
        >
           ...
           laptop:pl-24 mini-laptop:pl-10"
            ...
            text-gray-100 mb-6 "
              ...
              <div className="flex w-full mobile:justify-center">
                <Link href="https://github.com/ryotarofr" target={"_blank"}>
                  <button
